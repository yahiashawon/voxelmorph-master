...
def test(model_name, iter_num, gpu_id, vol_size=(160,192,224), nf_enc=[16,32,32,32], nf_dec=[32,32,32,32,32,16,16,3]):
	...
	labels = sio.loadmat('C:/Users/yhsha/Desktop/voxelmorph-master/voxelmorph-master/voxelmorph-master/data/labels.mat')['labels'][0]

	atlas = np.load('C:/Users/yhsha/Desktop/voxelmorph-master/voxelmorph-master/voxelmorph-master/data/atlas_norm.npz')
	atlas_vol = atlas['vol']
	atlas_seg = atlas['seg']
	...
	with tf.device(gpu):
		...
		net.load_weights('C:/Users/yhsha/Desktop/voxelmorph-master/voxelmorph-master/voxelmorph-master/models/' + model_name + '.h5')
	...
	X_vol, X_seg = datagenerators.load_example_by_name('C:/Users/yhsha/Desktop/voxelmorph-master/voxelmorph-master/voxelmorph-master/data/test_vol.npz', 'C:/Users/yhsha/Desktop/voxelmorph-master/voxelmorph-master/voxelmorph-master/data/test_seg.npz')
